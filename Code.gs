...
const CONFIG = {
  ...
  // הערה: שעת הסיום כאן היא לצורך חישוב התור האחרון בלבד (תור אחרון מתחיל 30 דק' לפני שעת הסיום)
  REGULAR_HOURS: {
    0: { start: '09:00', end: '13:30' }, // ראשון - תור אחרון 13:00
    1: { start: '09:00', end: '13:30' }, // שני - תור אחרון 13:00
    3: { start: '09:00', end: '12:00' }  // רביעי - תור אחרון 11:30
  },

  // שירותי מבחן - רק יום שני
  EXAM_HOURS: {
    1: { start: '09:00', end: '13:30' } // שני בלבד - תור אחרון 13:00
  },
